...
const LineDivider = () => {
    return (
        <View style={{ width: 3, paddingVertical: 18 }}>
...
const Home = ({ navigation }) => {
    ...
    function renderButtonSection() {
        return (
            <View style={{ flex: 1, justifyContent: 'center', padding: SIZES.padding }}>
                <View style={{ flex: 1, flexDirection: 'row', height: 0, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    {/* Claim */}
                    <TouchableOpacity
                        style={{ flex: 1 }}
    ...
    function renderMyBookSection(myBooks) {
        ...
        return (
            <View style={{ flex: 1 }}>
                {/* Header */}
                <View style={{ paddingHorizontal: SIZES.padding, flexDirection: 'row', justifyContent: 'space-between', marginBottom: SIZES.base }}>
